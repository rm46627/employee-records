...
public class Main {
    public static void main(String[] args) throws IOException, ExecutionException, InterruptedException {
        ...
        System.out.print(register.getEmployee(0).printData().contains("Szczecin"));
        System.out.print(register.getEmployee(0).printData().contains("painting"));
        System.out.print(register.getEmployee(1).printData().contains("Warszawa"));
        System.out.print(register.getEmployee(1).printData().contains("tennis"));
    }
}